...
Map is now current as of this commit.
```
...
- Run this automatically as part of your commit checklist (after `git commit`, before `git push`)
- If unsure what a new file does, infer from filename + directory context
- For large scaffolded features (10+ new files), group them by directory in the report
