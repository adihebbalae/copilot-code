...
3. Tell the user to start a new Cline conversation with the target agent role
...
## Full Protocol
See `.github/agents/manager.agent.md` — complete delegation templates, handoff format, skill routing, escalation rules, MVP mode.
